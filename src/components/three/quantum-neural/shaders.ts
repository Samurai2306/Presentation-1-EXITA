/** Общий simplex noise для узлов и рёбер (один источник — меньше расхождений при правках). */
...
export const NODE_VERTEX_SHADER = `${NOISE_GLSL}
...
export const CONNECTION_VERTEX_SHADER = `${NOISE_GLSL}
